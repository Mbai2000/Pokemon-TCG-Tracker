...
const options = [
  {
    ...
    options: [
      ...
      {
        value: "Wizards of the Coast Promos",
        label: "Wizards of the Coast Promos",
      },
  ...
  },
  {
    ...
    options: [{ value: "Legendary Collection", label: "Legendary Collection" }],
  },
  {
    label: "e-Card Series",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "EX Dragon", label: "EX Dragon" },
      {
        ...
        label: "EX Team Magma vs Team Aqua",
      },
      ...
      {
        value: "EX Unseen Forces Unown Collection",
        label: "EX Unseen Forces Unown Collection",
      },
  ...
  },
  {
    ...
    options: [{ value: "Nintendo Promos", label: "Nintendo Promos" }],
  },
  {
    ...
    options: [
      ...
      {
        value: "Diamond & Pearl Black Star Promos",
        label: "Diamond & Pearl Black Star Promos",
      },
  ...
  },
  {
    ...
    options: [
      {
        value: "HeartGold & SoulSilver Black Star Promos",
        label: "HeartGold & SoulSilver Black Star Promos",
      },
  ...
  },
  {
    ...
    options: [{ value: "Call of Legends", label: "Call of Legends" }],
  },
  {
    label: "McDonald's Collection", //Come Back
    options: [
      {
        value: "McDonald's Collection (2011)",
        label: "McDonald's Collection (2011)",
      },
      {
        value: "McDonald's Collection (2012)",
        label: "McDonald's Collection (2012)",
      },
      {
        value: "McDonald's Collection (2013)",
        label: "McDonald's Collection (2013)",
      },
      {
        value: "McDonald's Collection (2014)",
        label: "McDonald's Collection (2014)",
      },
      {
        value: "McDonald's Collection (2015)",
        label: "McDonald's Collection (2015)",
      },
      {
        value: "McDonald's Collection (2016)",
        label: "McDonald's Collection (2016)",
      },
      {
        value: "McDonald's Collection (2017)",
      ...
      {
        value: "McDonald's Collection (2021)/McDonald's 25th Anniversary",
        label: "McDonald's Collection (2021)/McDonald's 25th Anniversary",
      },
      { value: "McDonald's Match Battle", label: "McDonald's Match Battle" },
      {
        value: "McDonald's Match Battle 2023",
        label: "McDonald's Match Battle 2023",
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "Black & White Black Star Promos",
        label: "Black & White Black Star Promos",
      },
  ...
  },
  {
    ...
    options: [
      {
        value: "Sun & Moon Black Star Promos",
        label: "Sun & Moon Black Star Promos",
      },
  ...
  },
  {
    ...
    options: [
      {
        value: "Sword & Shield Black Star Promos",
        label: "Sword & Shield Black Star Promos",
      },
  ...
  },
  {
    ...
    options: [
      {
        value: "Scarlet & Violet Black Star Promos",
        label: "Scarlet & Violet Black Star Promos",
      },
